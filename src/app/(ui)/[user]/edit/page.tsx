  ...
  return (
    <div className="">
      <GeneralHeader backHref="/profile">
        <div className="font-bold text-sm">Editar perfil</div>
      </GeneralHeader>
      ...
      <section className="border-b-2 border-gray-900">
        ...
        >
          <div className="cursor-pointer bg-black/80 flex justify-center items-center size-12 rounded-full hover:bg-black">
      ...
      <section className="p-6 flex flex-col gap-4">
        <label>
          <p className="text-md text-gray-500 mb-2">Nome</p>
          <Input placeholder="Digite seu nome" value={user.name} />
        </label>

        <label>
          <p className="text-md text-gray-500 mb-2">Sobrenome</p>
          <Input placeholder="Digite seu sobrenome" value={user.lastName} />
        </label>

        <label>
          <p className="text-md text-gray-500 mb-2">Bio</p>
          <Textarea
        ...
        <label>
          <p className="text-md text-gray-500 mb-2">Link</p>
